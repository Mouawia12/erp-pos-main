...
class ExpensesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.ExpensesBill.index' , compact('bills'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.ExpensesBill.create',compact('expenses' , 'warehouses','bill_number'))->render();
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.ExpensesBill.view',compact('expenses' , 'warehouses','bill'))->render();
    }

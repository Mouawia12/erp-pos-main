...
class UpdateQuntityController extends SystemController
{
    ...
    public function index()
    {
        ...
        return view('admin.UpdateQuantity.index' , ['data' => $data]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.UpdateQuantity.create' , ['warehouses' => $warehouses]);
    }
    ...
    public function edit($id)
    {
        ...
        if($updateQuntity){
            ...
            $warehouses = Warehouse::all();
            return view('admin.UpdateQuantity.edit' , ['warehouses' => $warehouses , 'updateQuntity' => $updateQuntity ,
                'products' => $products]);
        }
    }

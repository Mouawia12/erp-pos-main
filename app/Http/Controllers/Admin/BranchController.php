...
class BranchController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'tax_number' => 'nullable',
            'cr_number' => 'nullable',
            'national_address_short' => 'nullable|string|max:255',
            'national_address_building_no' => 'nullable|string|max:255',
            'national_address_street' => 'nullable|string|max:255',
            'national_address_district' => 'nullable|string|max:255',
            'national_address_city' => 'nullable|string|max:255',
            'national_address_region' => 'nullable|string|max:255',
            'national_address_postal_code' => 'nullable|string|max:255',
            'national_address_additional_no' => 'nullable|string|max:255',
            'national_address_unit_no' => 'nullable|string|max:255',
            'national_address_proof_no' => 'nullable|string|max:255',
            'national_address_proof_issue_date' => 'nullable|date',
            'national_address_proof_expiry_date' => 'nullable|date',
            'national_address_country' => 'nullable|string|max:10',
        ...
        try {
            $branch = Branch::create([
                ...
                'national_address_short' => $request->national_address_short,
                'national_address_building_no' => $request->national_address_building_no,
                'national_address_street' => $request->national_address_street,
                'national_address_district' => $request->national_address_district,
                'national_address_city' => $request->national_address_city,
                'national_address_region' => $request->national_address_region,
                'national_address_postal_code' => $request->national_address_postal_code,
                'national_address_additional_no' => $request->national_address_additional_no,
                'national_address_unit_no' => $request->national_address_unit_no,
                'national_address_proof_no' => $request->national_address_proof_no,
                'national_address_proof_issue_date' => $request->national_address_proof_issue_date,
                'national_address_proof_expiry_date' => $request->national_address_proof_expiry_date,
                'national_address_country' => $request->national_address_country,

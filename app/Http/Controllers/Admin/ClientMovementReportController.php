...
class ClientMovementReportController extends Controller
{
    public function pdf(Request $request)
    {
        ...
        $payload = [
            ...
            'customer' => $request->filled('company_id') ? Company::find((int) $request->company_id) : null,
        ...
        $pdf = SnappyPdf::loadView('reports/client-movement', $payload)

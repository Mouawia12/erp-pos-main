...
class Client
{
     ...
     * @return $this
     */
    public function setClientIdentification(string $clientIdentification): self
    {
    ...
    /**
     * Set client identification value (TIN/NAT/etc).
     *
     * @param string|null $clientIdentificationValue
     *
     * @return $this
     */
    public function setClientIdentificationValue(string|null $clientIdentificationValue): self
    {
        return $this->setVatNumber($clientIdentificationValue);
    }
    ...
    public function getElement(): array
    {
        if (!empty($this->vatNumber)) {
            ...
            if (empty($this->plotIdentification)) {
                throw new Exception('Client plot identification required .');
            }
            ...
            'childs' => [
                [
                    ...
                    'childs' => [
                        [
                            'name' => 'ID',
                            'value' => ($this->clientIdentification == 'TIN') ? str_replace('00003', '', $this->vatNumber) : $this->vatNumber,
                            'namespaced' => true,
                            'namespace' => null,
                            'prefix' => 'cbc',
                            'attributes' => [
                                [
                                    'name' => 'schemeID',
                                    'value' => $this->clientIdentification,
                                    'namespaced' => false,
                                    'namespace' => null,
                                    'prefix' => null,
                                ],

...
<head>
    <meta charset="utf-8">
    <title>{{ __('main.purchases_report') }}</title>
    <style>
        @font-face {
            font-family: 'Tajawal';
...
<body>
    <div class="header">
        <h2>{{ __('main.purchases_report') }}</h2>
        ...
        <tbody>
            @forelse($rows as $detail)
                <tr>
                    ...
                    <td>{{ number_format($detail->net ?? 0, 2) }}</td>
                    <td>{{ number_format($detail->paid ?? 0, 2) }}</td>
                    <td>{{ number_format(((float) ($detail->net ?? 0) - (float) ($detail->paid ?? 0)), 2) }}</td>
                </tr>
            @empty
                <tr>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="smallBody"> 
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label>{{ __('main.expenses_category') }} <span class="text-danger">*</span> </label>
                                <select class="form-control" name="expenses_category" id="expenses_category" disabled>
                    ...
                    <div class="row">
                        <div class="col-6" >
                            <div class="form-group">
                                <label>{{ __('main.paid') }} <span class="text-danger">*</span> </label>

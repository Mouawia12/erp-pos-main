...
<div class="modal fade" id="expensesModal" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true"
     style="width: 100%;">
            ...
            <div class="modal-body" id="smallBody">
                <form  method="POST" action="{{ route('box_expenses_store') }}"
                    ...
                    <div class="row">
                        <div class="col-6" >
                            <div class="form-group">
                                <label>{{ __('main.bill_number') }} <span style="text-danger">*</span> </label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label>{{ __('main.bill_date') }} <span style="text-danger">*</span> </label>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label>{{ __('main.expenses_category') }} <span style="text-danger">*</span> </label>
                                <select class="js-example-basic-single w-100" name="expenses_category" id="expenses_category">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label>{{ __('main.warehouse') }} <span style="text-danger">*</span> </label>
                    ...
                    <div class="row">
                        <div class="col-6 " >
                            <div class="form-group">
                                <label>{{ __('main.paid') }} <span style="text-danger">*</span> </label>
                        ...
                        <div class="col-6 " >
                            <div class="form-group">
                                <label>{{ __('main.payment_type') }} <span style="text-danger">*</span> </label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label>{{ __('main.notes') }} <span style="text-danger">*</span> </label>

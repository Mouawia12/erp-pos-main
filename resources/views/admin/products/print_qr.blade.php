                        ...
                        <form   method="POST" action="#" class="no-print">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="paper_size" id="paper-size" required>
                                        <option value="0">Select paper size...</option>
                                        <option value="20">20 mm (0.77 inch)</option>
                                        <option value="30">30 mm (1.16 inch)</option>
                                        <option value="40">40 mm (1.5 inch)</option>

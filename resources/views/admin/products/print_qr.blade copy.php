            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0"  id="head-right" >
                        <div class="col-lg-12 margin-tb">
                            <h4  class="alert alert-primary text-center">
                                [ {{ __('main.products_list'). ' / '. __('main.print_qr')}} ]
                            </h4>
                        </div>
                    ...
                    <div class="modal-body" id="paymentBody">
                        <form   method="POST" action="{{ route('preview_qr') }}" class="no-print">
                            @csrf
                            ...
                            <div class="card mb-4">
                                <div class="card-header pb-0">
                                    <h4  class="alert alert-success text-center">{{__('main.select_print_options')}} </h4>
                                </div>
                                <div class="card-body px-0 pt-0 pb-2">
                                            ...
                                            @for ($r = 1; $r <= $item['quantity']; $r++)
                                                <div class="item style50" style="width:2in;height: 1in;border:0;">
                                                    <div class="div50" style="width:2in;height:1in;border: 1px dotted #CCC;padding-top:0.025in;">
                                                        <img id='barcode'
                                                             src="https://api.qrserver.com/v1/create-qr-code/?data={{$item['data']}}&amp;size=100x100"
                                                             alt=""
                                                             title="{{$item['name']}}"
                                                             width="90"
                                                             height="90" />

...
<script>
    $(document).ready(function () { 
        ...
        $('#TableCust tfoot tr th:nth-child(2)').html('<input class="form-control" type="text" placeholder="اسم الفرع" />');
        $('#TableCust tfoot tr th:nth-child(3)').html('<input class="form-control" type="text" placeholder="جوال الفرع" />');
        $('#TableCust tfoot tr th:nth-child(4)').html('<input class="form-control" type="text" placeholder="عنوان الفرع" />'); 
        $('#TableCust').DataTable({
            "columnDefs": [
                {"orderable": false, responsive: true, "targets": [0,4]}
            ],
            dom: 'lBfrtip',
            buttons: [

...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.advance_payment'). ' / '. __('main.add_advance_payment')])
<!-- End Navbar -->
    <div class="modal-body" id="paymentBody">
        <form   method="POST" action="{{route('advance_payments.store')}}">
            @csrf
                                ...
                                <div class="card m-b-30 col-md-6">
                                    ...
                                    <div class="card-body">
                                        <div class="input-group">
                                            <input type="date" id="default-date" required name="date"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-0">
                                            <input type="number" step="0.01"
                                                   class="form-control" required name="amount" id="amount" placeholder="{{__('main.Amount')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="card m-b-30 col-md-6">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-0">
                                            <input type="number" step="0.01"
                                                   class="form-control" required name="advance_amount" id="amount" placeholder="{{__('main.Advance Amount')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>

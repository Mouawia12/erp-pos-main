...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.salary_docs') ])
<!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.salary_docs')}}</h6>
                            </div>
                            <div class="col-6 text-end">
                                <a type="button" class="btn btn-labeled btn-primary" href="{{route('open_salary')}}">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table  id="table" class="table align-items-center mb-0 border">
                                <thead>
                                <tr>
                                    <th width="30%">{{__('main.invoice_no')}}</th>
                                    <th width="10%">{{__('main.Date')}}</th>
                                </tr>
                                </thead>
                                <tbody>

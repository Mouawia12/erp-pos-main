...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.rewards') ])
<!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.rewards')}}</h6>
                            </div>
                            <div class="col-6 text-end">
                                <a type="button" class="btn btn-labeled btn-primary" href="{{route('reward.create')}}">
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-group-sm" style="float: none;">
                                                <button type="button" class="btn btn-labeled btn-secondary"
                                                        onclick="location.href='{{route('reward.edit',$category->id)}}'"

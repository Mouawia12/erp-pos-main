...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.rewards'). ' / '. __('main.update_reward')])
<!-- End Navbar -->
                                    ...
                                    <div class="form-group mb-0">
                                        <select class="select2-single form-control" id="employer_id" name="employer_id">
                                            @foreach($employers as $employer)
                                                <option value="{{$employer->id}}" @if($employer->id == $reward->employer_id) selected @endif>{{$employer->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0">
                                        <input type="number" step="0.01"
                                               class="form-control" required name="amount" id="amount" placeholder="{{__('main.Amount')}}" value="{{$reward->amount}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card m-b-30 col-md-8">
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0">
                                        <textarea class="form-control" name="reason" aria-label="With textarea">{{$reward->reason}}</textarea>
                                    </div>
                                </div>
                            </div>

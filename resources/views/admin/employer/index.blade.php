...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.employers') ])
<!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.employers')}}</h6>
                            </div>
                            <div class="col-6 text-end">
                                <a type="button" class="btn btn-labeled btn-primary" href="{{route('employers.create')}}">
                            ...
                            <table  id="table" class="table align-items-center mb-0 border">
                                ...
                                @foreach($employers as $category)
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! round ($category->salary * $category->additional_salary,0)!!}</td>
                                        <td>

                                            <div class="btn-group btn-group-sm" style="float: none;">
                                                <button type="button" class="btn btn-labeled btn-secondary"
                                                        onclick="location.href='{{route('employers.edit',$category->id)}}'"
...
<script type="text/javascript">
    ...
    function remove(id){
        swal({
            ...
            var url = '{{route('employers.delete',':id')}}';
            url = url.replace(':id',id);

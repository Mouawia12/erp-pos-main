...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.employer_categories') ])
<!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.employer_categories')}}</h6>
                            </div>
                            <div class="col-6 text-end">
                                <a type="button" class="btn btn-labeled btn-primary" href="{{route('employer.categories.create')}}">
...
<script type="text/javascript">
    ...
    function remove(id){
        swal({
            ...
            var url = '{{route('employer.categories.delete',':id')}}';
            url = url.replace(':id',id);

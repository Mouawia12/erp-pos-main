                                ...
                                <table class="display w-100  text-nowrap table-bordered" id="example1" 
                                   style="text-align: center;direction: rtl;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-md-center font-weight-bolder opacity-7 ps-2">{{__('اجمالي اجور التصنيع')}}</th>
                                    ...
                                    @foreach($all as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">@if($item -> type == 1) {{'فاتورة مشتريات ذهب مشغول'}} @elseif($item -> type == 0 and $item -> bill_type == 0) {{'فاتورة مشتريات ذهب كسر'}}  @else {{'فاتورة مشتريات ذهب صافي'}}  @endif </td>
                                            ...
                                            <td class="text-center">{{$item -> made_total}}</td>
...
<script>
    $(document).ready(function () {
        document.title = "{{__('main.purchase_total_report')}}";
    });
</script>

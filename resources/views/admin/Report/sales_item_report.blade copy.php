...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#excute').click(function (){
            ...
            showReport( fromDate, toDate, warehouse, branch_id);
        });
        ...
        $(document).on('click', '.cancel-modal', function (event) {
            $('#item_sales_modal').modal("hide"); 
        });
        
        document.title = "{{__('main.sales_report_by_item')}}";

    });

    function showReport( fdate, tdate, warehouse, branch_id) {
        var route = '{{route('sales.item.report.search',[":fdate" , ":tdate" , ":warehouse", ":branch_id"] )}}';

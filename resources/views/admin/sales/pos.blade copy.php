                                ...
                                <div class="col-lg-4"> 
                                    <div class="row" > 
                                        <input type="datetime-local" id="bill_date" name="bill_date" hidden
                                               class="form-control"/> 
                                        <input type="text"  id="invoice_no" name="invoice_no" hidden
                                               class="form-control" placeholder="invoice_no"/>
                                        <input type="text"  id="POS" name="POS" hidden value="1"
                                               class="form-control" placeholder="invoice_no"/> 
                                    </div>
                                    <div class="row" > 
                                        <div class="col-md-11 alert-primary text-center text-primary" >   
                                            <label style="padding-top:5px;"><strong>{{__('main.total.final')}}</strong></label>
                                            <h4 id="totalBig"><strong>0.00</strong></h4> 
                                        </div> 
                                    </div> 
                                </div>
                            </div>  
...
<script type="text/javascript">
    ...
    function getBillNo(){
        ...
        var url = '{{route('get.sale.pos.no',":id")}}';

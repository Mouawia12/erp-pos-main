                    ...
                    <div class="col-md-4">
                        ...
                        <select name="customer_id" class="form-control" required>
                            @foreach($customers as $c)
                                <option value="{{ $c->id }}" @if($quotation->customer_id==$c->id) selected @endif>{{ $c->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="warehouse_id" class="form-control" required>
                            @foreach($warehouses as $w)
                                <option value="{{ $w->id }}" @if($quotation->warehouse_id==$w->id) selected @endif>{{ $w->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label>{{ __('main.note') ?? 'ملاحظات' }}</label>
                        <input type="text" name="note" class="form-control" value="{{ $quotation->note }}">
                    </div>
                </div>

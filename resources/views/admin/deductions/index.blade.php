...
<!-- Navbar -->
@include('layouts.nav' , ['page_title' => __('main.deductions') ])
<!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.deductions')}}</h6>
                            </div>
                            <div class="col-6 text-end">
                                <a type="button" class="btn btn-labeled btn-primary" href="{{route('deduction.create')}}">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table  id="table" class="table align-items-center mb-0 border">
                                ...
                                <tbody>
                                @foreach($deductions as $category)
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-group-sm" style="float: none;">
                                                <button type="button" class="btn btn-labeled btn-secondary"
                                                        onclick="location.href='{{route('deduction.edit',$category->id)}}'"

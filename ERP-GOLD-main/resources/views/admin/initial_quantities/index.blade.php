...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var table = $('#SalesTable').DataTable({
                ...
                ajax: "{{ route('initial_quantities.index') }}",
                columns: [
                    {
                        data: 'id', 
                        name: 'id'
                ...
                buttons: [
                    {   
                        text: ' @can("employee.initial_quantities.add") <a id="createButton" href="javascript:;" class="text-white"><i class="fa fa-plus"></i></a>  @endcan ',
                    }, 
                    {
                        extend: 'excel',

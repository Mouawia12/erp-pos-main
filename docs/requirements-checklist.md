...
- [⚠️] اختيار الوحدة المباعة مع تحذير عند تكرار الصنف (التحذير مضاف، أصبح بالإمكان اختيار وحدة البيع وربطها بالكمية المسحوبة مع معامل تحويل، ما زال ضبط المعاملات المتقدمة قيد المراجعة).
...
- [⚠️] نوع الفاتورة: ضريبية/غير ضريبية/ضريبية مبسطة مع إمكانية تثبيت النوع وتعديله (إضافة حقل اختيار النوع وحفظه/طباعته أُنجزت؛ تثبيت النوع افتراضيًا لكل مستخدم/فرع ما زال قيد المتابعة).
- [⚠️] شروط وأحكام/ضمان قابلة للحفظ والتعديل والحذف والطباعة (تم إضافة نص افتراضي في إعدادات النظام وعرضه في الطباعة؛ بقية إدارة النماذج المتعددة قيد المتابعة).
- [ ] مقاسات طباعة: A4/A5/فاتورة نقطية (كاشير).
- [ ] منع تعديل أو حذف الفاتورة بعد الترحيل. (لم يُنفذ بعد؛ قيد الإقفال)
- [ ] منع تعديل التاريخ والوقت.
- [ ] بحث متقدم برقم/تاريخ/عميل/مندوب/صنف.
- [ ] اختصارات إضافة عميل/صنف/مندوب من شاشة الفاتورة.

### فواتير المشتريات
- [ ] نفس سلوك الوحدات والتحذير عند التكرار (تم إضافة تحذير التكرار، الوحدات ما زالت قيد المراجعة).

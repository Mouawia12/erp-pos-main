...
- [ ] إعدادات النظام الموحدة: ترقيم تلقائي/يدوي للأصناف/الأقسام/المجموعات/الماركات، تنبيهات تلقائية (انتهاء كمية أو تاريخ صنف أو وثائق مندوب)، إعدادات الطباعة (A4/A5/كاشير)، إعدادات الحسابات والمخزون، وضع نقاط البيع (لمس/عادي)، الصلاحيات والمستخدمين. (تم إضافة نوع فاتورة افتراضي/تسجيل جهاز واحد، باقي البنود قيد العمل)
